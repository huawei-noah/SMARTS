...
format:
	...
	isort -m VERTICAL_HANGING_INDENT --skip-gitignore --ac --tc --profile black ./baselines/marl_benchmark/ ./baselines/driving_smarts ./cli ./envision ./examples/ ./utils/ ./scenarios/ ./smarts ./zoo
	black --version
	black .
