...
class ReplayCheckerAgent(Agent):
    ...
    def load_data_for_vehicle(
        ...
        datafile = f"{observation_folder}/{scenario.name}_{scenario.traffic_history.name}_Agent-history-vehicle-{vehicle_id}.pkl"
    ...
    for scenario in scenarios_iterator:
        ...
        for episode in range(episodes):
            ...
            for agent_id in agent_interfaces.keys():
                ...
                agent.load_data_for_vehicle(
                    veh_id, scenario, history_start_time, dataset_source
                )
