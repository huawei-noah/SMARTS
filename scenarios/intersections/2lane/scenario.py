...
mission = Mission(Route(begin=('edge-west-WE', 0, 10),
                        end=('edge-north-SN', 0, 50)),
                  entry_tactic=TrapEntryTactic(wait_to_hijack_limit_s=0,
                                               default_entry_speed=3.0))

gen_scenario(Scenario(ego_missions=[mission]),
