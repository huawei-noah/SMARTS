...
traffic = t.Traffic(
    flows=[
        t.Flow(
            ...
            rate=1,
            end=10, # since rate=1 means introducing 1 more vehicle per hour, so set any value less than 1 hr (1*60*60 secs) here could make sure no more vehicles get introduced after the initial flow.
