...
python_files="$(find ./cli ./envision ./smarts -name '*.py' ! -name '*_pb2.py' ! -name '*_pb2_grpc.py' ! -wholename './smarts/waymo/waymo_open_dataset/__init__.py' ! -wholename './smarts/waymo/waymo_open_dataset/protos/__init__.py')"
