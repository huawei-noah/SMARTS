...
# define parse args
def parse_args():
    parser = argparse.ArgumentParser("independent learning")
...
def main(args):
    ...
    analysis = tune.run(
        ...
        max_failures=1000,
        # current rllib version have problem when export multi agent models whose
        # policy name is not "default_policy"
    ...
    dest_model_path = os.path.join(log_dir, experiment_name, "model")
