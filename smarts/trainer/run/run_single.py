...
def parse_args():
    parser = argparse.ArgumentParser("run single agent learning")
...
def main(args):
    ...
    # init env config
    # ====================================
    rllib_agent = rllib_trainable_agent(continuous_action=args.algorithm in ["PPO"])
    ...
    experiment_name = EXPERIMENT_NAME.format(
        scenario=args.scenario, algorithm=args.algorithm, n_agent=1,
    )
