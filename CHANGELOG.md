...
- Collisions now give the vehicle id rather than the name of the owner of the vehicle (usually the agent id.) This is because in most cases the owner name would be `None`.
### Deprecated
### Fixed
